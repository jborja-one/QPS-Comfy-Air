...
import ServiceDiagnostics from '../../images/services-diagnostics.jpeg';
				...
				<div className='service-page_header'>
					<div className='service-page_header-img position-relative'>
						...
						<h2 className='about-us-header_title position-absolute bold-text'>
							Our Services <br></br> Diagnostics
						</h2>
					</div>
				</div>
			</div>
				...
				<div className='row'>
					...
					<div className='col-md-8'>
						<div className='service-page_content'>
							<div className='row' id='diagnostics'>
...
export default ServiceDiagnosticsPage;
